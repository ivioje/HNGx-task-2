...
const Hero = () => {
	return (
		<>
			<div className="hero md:h-[100vh] h-full w-full font-dmSans text-white sm:px-16 px-2 pb-4">
				{/*Navbar */}
				<Navbar />
				...
				<div className="flex flex-col items-center md:items-start md:justify-normal justify-center">
					...
					<div className="xs:flex hidden items-center flex-col px-3 text-[12px] absolute text-gray-400 right-0 top-[50%]">
